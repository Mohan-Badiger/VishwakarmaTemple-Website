...
const WomanCommittee = () => {
    return (
        <div>
            <section className="max-w-7xl mx-auto mt-30 mb-20">
                <h1 className="text-3xl sm:text-5xl text-yellow-900 font-medium text-center mx-auto font-cinzel">Woman's Committee</h1>
