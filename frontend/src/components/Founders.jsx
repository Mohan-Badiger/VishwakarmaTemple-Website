...
const Founders = () => {
  return (
    <>
      <section className="max-w-7xl mx-auto mt-15 mb-20">
        <h1 className="text-5xl text-yellow-900 font-medium text-center mx-auto font-cinzel">Banahatti Temple Founders.</h1>
